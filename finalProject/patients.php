...
<body>
            ...
            <nav>
                <ul class="nav-ul">
                    ...
                    <li class="nav-li"><a class="nav-a" href="#">Information</a>
                        <ul>
                            <li><a class = "nav-a" href="#">Patient List</a></li>
    ...
    <div class="formContainer">
        <h1>Patients list</h1>
        <form class="inputForm" method = "post" action="patients.php" style="margin:auto;max-width:700px">
            <input type="text" placeholder="Enter Patient's First Name, Last Name or ID" name="search2"></li>
