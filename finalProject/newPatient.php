    ...
    <html>
        ...
        <body>
                    ...
                    <nav>
                        <ul class="nav-ul">
                            ...
                            <li class="nav-li"><a class="nav-a" href="#">Forms</a>
                                <ul>
                                    <li><a class = "nav-a" href="#">New Patient</a></li>
            ...
            <div class='container formContainer'> 
                ...
                <form class="inputForm" id="newPatientForm" onsubmit="return validateNewPatient()" method="post" action="patients.php" enctype="multipart/form-data"> 
                    ...
                    <button class="inputBtn submit" type="submit" name="newPatient">Submit</button>
                </form>
            </div>
        </body>
        <footer>
