...
<?php if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true): ?>
    <html>
        <head>
            <title>Edit Prescription Form</title>
                        ...
                        <ul class="nav-ul">
                            ...
                            <li class="nav-li"><a class="nav-a" href="#">Forms</a>
                                <ul>
                                    ...
                                    <li><a class = "nav-a" href="#">Edit Prescription</a></li>
                                </ul>
                            </li>
                            <li class="nav-li"><a class="nav-a" href="loginFirst.php">Logout</a></li>
                        </ul>
                    </nav>
                </div>
            </header>
            <div class='container formContainer'> 
                <h1>Edit Prescription Form</h1>
                <form class="inputForm" id="prescriptionForm" method="post" action="medications.php" onsubmit="return validateNewMedPrescription()">
                    <div class = "inputField">
                        ...
                        <select id= "prescriptionOption" name="Prescription Options" onchange="OptionsToggler()" class="required" autocomplete="off" required>
                    ...
                    <div class="medOpt">
                        ...
                        <input class="formInput" type="text" placeholder="Enter Medication ID" name="MedicationID" id="medID" onfocusout="validateMedID()"/>
                        <span class="errorTxt"></span>
                    </div>
                    <div class="DROpt" style="display:none;">
                        <label for="dietID">Diet ID</label> 
                        <input class="formInput" type="text" placeholder="Enter Diet ID" name="DietID" id="dietID" onfocusout="validateDietID()"/>
                        <span class="errorTxt"></span>
                    </div>
                    <div> 
                    ...
                    <button class="inputBtn submit medOpt" type="submit" name="editMed" onclick="validateNewMedPrescription()">Edit Medication</button>
                    <button class="inputBtn submit medOpt" type="submit" name="removeMed" style="background:red;" >Remove Medication</button>
                    <button class="inputBtn submit DROpt" type="submit" name="editDR" style="display:none;" onclick="validateNewDietPrescription()">Edit Diet Regime</button>
                    <button class="inputBtn submit DROpt" type="submit"  name="removeDR" style="background:red; display:none;"  >Remove Diet Regime</button>
                </form>
            </div>
